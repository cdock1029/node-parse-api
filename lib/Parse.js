...
Parse.prototype = {
    ...
    find: function (className, query, callback, sessionToken) {
        ...
        parseRequest.call(this, 'GET', url, null, callback, null, sessionToken);
    },
    ...
    loginUser: function (username, password) {
        var d = Q.defer();
        parseRequest.call(this, 'GET', '/1/login/?username=' + username + '&password=' + password, null, function(err, result) {
            if (err) {
                d.reject(err);
            } else {
                d.resolve(result);
    ...
    session: function (sessionToken, callback) {
        parseRequest.call(this, 'GET', '/1/sessions/me', null, callback, null, sessionToken);
    },
